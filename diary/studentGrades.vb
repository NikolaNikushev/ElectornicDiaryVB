Public Class StudentGrades
    ...
    Private Sub save_Click(sender As Object, e As EventArgs) Handles save.Click
        ...
        If functions.CheckSelectedEntry(subjectList) Then
            ...
            'Запазва информацията на ученика за учебния предмет
    ...
    Private Sub confirmChoice_Click(sender As Object, e As EventArgs) Handles confirmChoice.Click
        ...
        'Чете информацията и изчислява успехът и отсъствията
        ...
        functions.AverageGrade(studentGradesList, AverageGrade)
        functions.AbsenceSum(studentAbsenceList, AbsenceSums)

    End Sub

    'Пише по файлът, съхраняващ отсъствията и изчислява броя отсъствия
    ...
    Private Sub removeAbsence_Click(sender As Object, e As EventArgs) Handles removeAbsence.Click
        ...
        End If
    End Sub
    'Пише по файлът, съхраняващ оценките и изчислява средният успех по предмет
    ...
    'Премахва информацията от файлът, съхраняващ оценките и изчислява новият среден успех
    Private Sub removeGrade_Click(sender As Object, e As EventArgs) Handles removeGrade.Click
        If functions.CheckSelectedEntry(studentGradesList) Then
            If functions.ConfirmAction() Then
                summary.summaryView.Items.Add("Премахната оценка на Номер " & labelStudentNumber.Text & ":" & studentGradesList.SelectedItems(0).Text)
